...
maptalks.Util.extend(maptalks.LineString.prototype.arrowStyles, {
	...
	_getArrowShape(prePoint, point, lineWidth, arrowStyle, tolerance) {
		...
		if (point.nextCtrlPoint || point.prevCtrlPoint) {
			...
			if (point.prevCtrlPoint) {
				normal = point.sub(new maptalks.Point(point.prevCtrlPoint));
			} else {
				normal = point.sub(new maptalks.Point(point.nextCtrlPoint));
			}
		} else {
